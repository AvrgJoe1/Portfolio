# Cisco Password Challenge (Root-Me)
...
line vty 0 4
 ...
 ## Found Cisco 7 Password Cracker
    
    https://www.ifm.net.nz/cookbooks/passwordcracker.html

    Used this website to find the passwords for the other usernames.


 #### Looking for the "enable" password
    Found that all the other Passwords are [6sK0_(username)] 

    Password: 6sk0_enable